...
- **`@eco00/ssr-foundations`** — SSR server Bun + Preact. Filesystem routing, middleware, RBAC, session.
- **`@eco00/data-dictionary-v1`** — schema canônico de Data Dictionary com Zod.
- **`@eco00/dd-validation-runtime`** — runtime de validação baseado no Data Dictionary.
